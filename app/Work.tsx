        ...
        <div className="flex md:flex-col md:gap-4 group dark:scrollbar-track-zinc-900 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 dark:scrollbar-thumb-zinc-800 overflow-x-auto md:overflow-clip max-w-xl text-sm md:text-base ">
          <button
            className={` dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400 md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${
              workIndex === 0 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"
            }`}
            onClick={() => ChangeWorkIndex(0)}
          >
            <div className="flex gap-1 items-center ">
              <div className="p-1">
                <Image
                  width={100}
                  height={100}
                  className="w-3 h-2 min-w-3 mt-1 md:mt-0"
                  src="/icons/Tnc-logo.png"
                  alt="tnc"
                />
              </div>
              TNC
          ...
          <button
            className={` dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400 md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${
              workIndex === 1 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"
            }`}
            onClick={() => ChangeWorkIndex(1)}
          >
          ...
          <button
            className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${
              workIndex === 2 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"
            }`}
            onClick={() => ChangeWorkIndex(2)}
          >
          ...
          <button
            className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center ${
              workIndex === 3 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"
            }`}
            onClick={() => ChangeWorkIndex(3)}
          >
            <div className="flex gap-2 items-center ">
              <div className="dark:bg-zinc-800  rounded-full p-1">
                <Image
          ...
          <button
            className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center ${
              workIndex === 4 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"
            }`}
            onClick={() => ChangeWorkIndex(4)}
          >
            <div className="flex gap-2 items-center ">
              <div className="p-1 dark:bg-zinc-800 rounded-full">
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <polygon
                      // class="a"
                      points="33.614 33.614 42.864 42.864 42.864 5.864 5.864 5.864 15.114 15.114 33.614 15.114 33.614 33.614"
                    ></polygon>
                    <polygon
                      // class="a"
                      points="15.114 33.614 15.114 19.55 5.885 28.778 5.864 42.864 19.949 42.842 29.177 33.614 15.114 33.614"
                    ></polygon>
                  </g>
                </svg>
              </div>
        ...
        <div className="dark:text-zinc-400 text-gray-900  flex flex-col gap-3 md:max-w-xl mx-auto ">
          <div className="text-base md:text-2xl dark:text-zinc-100  ">
            ...
            <span className="text-cyan-500">
              @ {workData[workIndex].company}
            </span>
          </div>
          <div className="text-sm tracking-widest">
            {workData[workIndex].timeline}
          </div>
          <div className="text-sm tracking-widest">
            {workData[workIndex].location}
          </div>
          <div className="text-sm flex flex-col gap-2">
            {workData[workIndex].description.map((description: string) => (
...
const WorkData = [
  ...
  },
  {
    ...
    location: "Toronto, ON",
    description: [
      "Developed a predictive analytics dashboard that improved the first pass yield (FPY) of the linear sorter by 25%, enhancing sorting accuracy and efficiency",
  ...
  },
  {
    ...
    location: "Toronto, ON",
    description: [
      "Designed a full-stack CMS for retail electronics inventory enhancing data accuracy and operational efficiency",
  ...
  },
  {
    ...
    location: "Toronto, ON",
    description: [
      "Automated over 100 testing procedures with Perl and Bash scripts, integrating them with existing CI/CD pipelines to improve testing efficiency",
